    ...
    fix () {
        ...
        for ( const dependency of this.#dependencies ) {
            ...
            if ( dependency.versionType === "git" ) {
                this.config[ dependency.type ][ dependency.name ] = this.config[ dependency.type ][ dependency.name ].replace( /#semver:(.+)$/v, "#semver:" + dependency.range.range );
            }
            else {
            ...
            // url
                ...
                try {
                    ...
                    if ( url.protocol.startsWith( "git" ) ) {
                        ...
                        // parse #semver=
                        const match = url.hash.match( /#semver:(.+)$/v );
