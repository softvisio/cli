...
export default class extends Command {
    ...
    async run () {
        ...
        console.log( `
Online systems (${ password.bruteForceEstimations.online.rate }  attempts / second): ${ password.bruteForceEstimations.online.interval.toYears().truncated } years
Offline systems (${ password.bruteForceEstimations.offline.rate }  attempts / second): ${ password.bruteForceEstimations.offline.interval.toYears().truncated } years
`.trim() );
