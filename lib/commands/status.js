...
export default class extends Command {
    ...
    static cli () {
        return {
            "options": {
                ...
                "branches": {
                    "short": "b",
                    "description": "show branches info",
                    "default": false,
                    "schema": { "type": "boolean" },
                },
                "links": {
    ...
    async run () {
        ...
        var res, hasOutput, showBranches;
        ...
        if ( !process.cli.options.status && !process.cli.options.branches && !process.cli.options.links ) {
            showBranches = true;
        }
...
`.trim() );
        ...
        // branches
        if ( showBranches || process.cli.options.branches ) {
            if ( hasOutput ) {
                console.log();
            }
