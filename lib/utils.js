...
const cliConfigSchema = new Ajv().addSchema( await readConfig( import.meta.resolve( "#resources/schemas/scli.config.schema.yaml" ) ) ),
    defaultCliConfig = await readConfig( "#resources/scli.config.yaml", { "resolve": import.meta.url } );
