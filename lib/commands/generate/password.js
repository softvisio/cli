...
Online systems (${ Locale.default.formatNumber( password.bruteForceEstimations.online.rate ) }  attempts / second): ${ Locale.default.formatRelativeDate( password.bruteForceEstimations.online.interval ) }
Offline systems (${ Locale.default.formatNumber( password.bruteForceEstimations.offline.rate ) }  attempts / second): ${ Locale.default.formatRelativeDate( password.bruteForceEstimations.offline.interval ) }
